...
export function AdminAccessPanel({ redirectTo, title, description }: AdminAccessPanelProps) {
  ...
  return (
    <section className="mx-auto max-w-xl space-y-4 rounded-2xl border border-ink-200/70 bg-white/80 p-6 dark:border-ink-700 dark:bg-ink-900">
      ...
      <p className="text-xs text-neutral-500 dark:text-neutral-400">可通过环境变量 `SITE_ADMIN_PASSWORD` 自定义密码。</p>
    </section>
  );
}
